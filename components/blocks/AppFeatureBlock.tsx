...
export const AppFeatureBlock: React.FC<Props> = ({appName, appDescription, appStoreUrl, imageUrl, playStoreUrl}) => {
    return (
        <>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 220" className="-mt-5"><path fill="#111827" fillOpacity="1" d="M0,160L80,144C160,128,320,96,480,96C640,96,800,128,960,128C1120,128,1280,96,1360,80L1440,64L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>     
        </>
    )
}